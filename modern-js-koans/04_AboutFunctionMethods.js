...
xdescribe('call, apply의 유용한 예제를 확인합니다', () => {
  ...
  it('prototype의 기능을 빌려 쓸 수 있습니다', () => {
    ...
    expect(Array.prototype.concat.apply(array1, [array2])).to.eql(['code', 'states', 'immersive', 'course', 5, 10, 4, 9])
  })
...
xdescribe('bind의 유용한 예제를 확인합니다', () => {
  ...
  it('callback에 인자를 전달하기에 유용합니다', () => {
    ...
    function callback(user) {
      ...
      btn.onclick = handleClick.bind(null, user) // 이 부분을 bind를 이용해서 테스트가 통과하도록 바꿔보세요
      btn.trigger()
    }
